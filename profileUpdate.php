                            ...
                            <div class="col">
                                <div class="card shadow mb-3">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <br>
                                        <!-- <div class="mb-3"><button class="btn btn-primary btn-sm" type="submit" id ="submit" name="submit" >Edit Details</button></div>-->
                                ...
                                <div class="row">
                                    <div class="col">
                                        <div class="card shadow">
                                            ...
                                            <div class="card-body">
                                                <!-- <form> -->
                                                <div class="mb-6"><label class=""><strong>Contact Number</strong></label></div>
                                                <?php
                                                if ($res = mysqli_fetch_array($result7)) {
                                                    if (empty($res['user_contact_num'])) {
                                                        echo '-';
                                                    } else {
                                                ...
                                                ?>
                                                <div class="mb-6"><label class=""><strong><br>Address</strong></label></div>
                                                <?php
                                                ...
                                                <div class="row">
                                                    <div class="col">
                                                        <div class="mb-6"><label class=""><strong><br>City</strong></label></div>
                                                        <?php
                                                        if ($res = mysqli_fetch_array($result9)) {
                                                            if (empty($res['user_city'])) {
                                                                echo '-';
                                                            } else {
                                                                echo $res['user_city'];
                                                            }
                                                    ...
                                                    <div class="col">
                                                        <div class="mb-6"><label class=""><strong><br>Country</strong></label></div>
                                                        <?php
                                                        if ($res = mysqli_fetch_array($result10)) {
                                                            if (empty($res['user_country'])) {
                                                                echo '-';
                                                            } else {
