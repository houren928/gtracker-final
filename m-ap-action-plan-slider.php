    ...
    <nav class="navbar navbar-dark align-items-start sidebar sidebar-dark accordion bg-cus p-0">
        ...
        <div class="d-flex flex-column" id="content-wrapper">
            ...
            <nav class="navbar navbar-light navbar-expand bg-white shadow mb-4 topbar static-top">
                        ...
                        <div class="simple-slider">
                            <div class="swiper-container">
                                <div class="swiper-wrapper">
                                    <!-- <div class="swiper-slide">
                                        <div class="acbox" style="background: var(--bs-light);">
                                            <section class="newsletter-subscribe" style="margin-top: 25px;padding-top: 25px;">
                                                <div class="container">
                                                    <div class="intro">
                                                        <h2 class="text-center">Less Weight 10 KG&nbsp;</h2>
                                        ...
                                        <section class="highlight-clean" style="padding-top: 0px;"></section>
                                    ...
                                    <div class="swiper-slide">
                                        <div class="acbox" style="background: var(--bs-light);">
                                            <section class="newsletter-subscribe" style="margin-top: 25px;padding-top: 25px;">
                                                <div class="container">
                                                    <div class="intro">
                                                        <h2 class="text-center">Meeting with Teacher<br></h2>
                                    ...
                                    <?php include_once "include/m-ap-action-plan-slider-process.php"; // Always include the database oconnection before accessing the database?>
                                </div>
                ...
                <div class="text-center mt-5"><a href="m-ap-action-plan.php?gid=<?php echo $goalID;?>&mid=<?php echo $menteeID;?>">← Back to Main Goal Page</a></div>
                </div>
