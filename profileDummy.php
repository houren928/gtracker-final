                            ...
                            <div class="card shadow mb-3">
                                ...
                                <div class="card-body">
                                    <form method="POST" action="processDummy.php">
                                        ...
                                        <div class="row">
                                            <div class="col">
                                                <div class="mb-3"><label class="form-label" for="first_name"><strong>Age</strong></label><input class="form-control" type="text" id="age" placeholder="32" name="age"></div>
                                            </div>
                                            <div class="col">
                                                <div class="mb-3"><label class="form-label" for="last_name"><strong>Gender</strong></label><input class="form-control" type="text" id="gender" placeholder="Male" name="gender"></div>
                                            </div>
                                        </div>
                            ...
                            <div class="row">
                                <div class="col">
                                    <div class="card shadow">
                                        ...
                                        <div class="card-body">
                                            <form method="POST" action="processDummy.php">
                                                <div class="mb-3"><label class="form-label" for="contact"><strong>Contact Number</strong></label><input class="form-control" type="text" id="contact" placeholder="+60184724920" name="contact" required></div>
