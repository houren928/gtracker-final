        ...
        <div class="d-flex flex-column" id="content-wrapper">
            <div id="content">
                ...
                <section class="contact-clean">
                    <form method="post" action="ap-add-new-activity-process.php">
                        <h2 class="text-center">New Activity</h2>
                        ...
                        <fieldset style="margin-bottom: .5rem;"><label class="form-label" style="font-size: 13px;">Target Completion Date</label><input class="form-control" type="date" name="ap-activity-date"></fieldset>
                        <fieldset style="margin-bottom: .5rem;"><label class="form-label" style="font-size: 13px;">Target Completion Time</label><input class="form-control" type="time" name="ap-activity-time"></fieldset>
                        <fieldset style="margin-bottom: .5rem;"><label class="form-label" style="font-size: 13px;">Location</label><input class="form-control" type="text" name="ap-activity-location"></fieldset>
                        <?php
                        $goalID = $_GET['goal-id'];
                        echo '<input class="form-control" type="text" name="ap-goal-id" value="';
                        echo $goalID;
                        echo '" hidden>';
                        ?>
