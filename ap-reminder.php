        ...
        <div class="d-flex flex-column" id="content-wrapper">
            <div id="content">
                ...
                <section class="contact-clean">
                    <form method="post" action="ap-add-new-reminder-process.php">
                        <h2 class="text-center" style="margin-bottom: 5px;">Reminder</h2>
                        <h6 class="text-center" style="margin-top: -0;font-size: 15px;color: rgba(6,5,5,0.27);">
                            <?php
                            include_once "include/config.php"; // Always include the database oconnection before accessing the database
                            $goalID = $_GET['goal-id'];
                        ...
                        <div class="mb-3"></div>
                        <div class="mb-3"></div>
                        <fieldset style="margin-bottom: .5rem;"><label class="form-label" style="font-size: 13px;">Date</label><input class="form-control" type="date" name="ap-reminder-date"></fieldset>
                        <fieldset style="margin-bottom: .5rem;"><label class="form-label" style="font-size: 13px;">Time</label><input class="form-control" type="time" name="ap-reminder-time"></fieldset>
                        <fieldset style="margin-bottom: .5rem;"><label class="form-label" style="font-size: 13px;">Notes</label><input class="form-control" type="text" name="ap-reminder-notes"></fieldset>
                        <?php
                        echo '<input class="form-control" type="text" hidden name="ap-goal-id" value="';
                        echo $goalID;
                        echo '">';
                        echo '<input class="form-control" type="text" hidden name="ap-activity-id" value="';
                        echo $activityID;
                        echo '">';
                        ?>
                ...
                <div class="container-fluid">
                    <div class="text-center mt-5"><a href="/ap-action-plan-slider.html">← Back to Activity</a></div>
                </div>
            </div>
