            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    <div class="row" style="height: 47.5938px;">
                        ...
                        <!-- <div class="col">
                            <div class="text-md-end dataTables_filter" id="dataTable_filter"><button class="btn btn-primary" role="button" onclick="document.location='ap-new-goal.php'" style="margin-right: 6px;"><svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" fill="currentColor" viewBox="0 0 16 16" class="bi bi-plus-circle">
                ...
                <!-- <div class="container-fluid">
                    ...
                    <div class="card shadow">
                        <div class="card-header py-3">
                            <p class="text-primary m-0 fw-bold">Monthly Goals</p>
                        </div>
                    ...
                    <div class="card shadow" style="margin-top: 30px;">
                        <div class="card-header py-3">
                            <p class="text-primary m-0 fw-bold">All Goals</p>
                        </div>
                        <div class="card-body" id="mentor-info">
                                <div class="container mt-5">
                                    <div class="row">
...
<!-- <script>
    ...
    $(document).ready(function() {
       let table1 = $('table#dataTable1').DataTable();
       let table2 = $('table#dataTable2').DataTable();
    ...
    $('#dataTable1 tbody tr').hover(function() {
        $(this).css('cursor', 'pointer');
        }, function() {
        $(this).css('cursor', 'auto');
        });
    $('#dataTable2 tbody tr').hover(function() {
        $(this).css('cursor', 'pointer');
        }, function() {
        $(this).css('cursor', 'auto');
        });
