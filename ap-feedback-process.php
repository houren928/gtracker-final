...
?>
            <div class="col-md-6 col-lg-4 item">
                ...
                <div class="author"><img class="border rounded-circle" src="<?php if (empty($mentor_details['user_photo'])) {
                                                                                $photoSource = "assets/img/default_pp.png";
                                                                            } else {
                                                                                // $photoSource = "assets/img/default_pp.png";
                                                                                
                                                                                $photoSource = 'data:image/jpeg;base64,' . base64_encode($mentor_details['user_photo']) . '';
                                                                            } 
                                                                            echo $photoSource;
                                                                            ?>">
