        ...
        <div class="d-flex flex-column" id="content-wrapper">
            ...
            <nav class="navbar navbar-light navbar-expand bg-white shadow mb-4 topbar static-top">
                ...
                <section class="contact-clean">
                    <form method="post" action="ap-add-new-goal-process.php">
                        <h2 class="text-center">New Goal</h2>
                        <div class="mb-3"><input class="form-control" type="text" name="title" placeholder="Goal Title"></div>
                        <div class="mb-3"><textarea class="form-control" name="description" placeholder="Goal Description" rows="14"></textarea></div>
                        <h5 class="fw-bold">SMART Field</h5>
                        <fieldset style="margin-bottom: .5rem;"><input class="form-control" type="text" placeholder="Specific" name="ap_specific"><label class="form-label fw-normal text-black-50" for="ap-specific" style="--bs-body-font-size: 1rem;font-size: 12px;">Specific: Well defined, clear, and unambiguous<br></label></fieldset>
                        <fieldset style="margin-bottom: .5rem;"><input class="form-control" type="text" placeholder="Measurable" name="measurable"><label class="form-label fw-normal text-black-50" for="measurable" style="font-size: 12px;">Measurable: With specific criteria that measure your progress toward the accomplishment of the goal<br></label></fieldset>
                        <fieldset style="margin-bottom: .5rem;"><input class="form-control" type="text" placeholder="Achievable" name="achievable"><label class="form-label fw-normal text-black-50" for="achievable" style="font-size: 12px;">Achievable: Attainable and not impossible to achieve<br></label></fieldset>
                        <fieldset style="margin-bottom: .5rem;"><input class="form-control" type="text" placeholder="Realistic" name="realistic"><label class="form-label fw-normal text-black-50" for="realistic" style="font-size: 12px;">Realistic: Within reach, realistic, and relevant to your life purpose<br></label>
                            <div class="container" style="padding: 0px;">
                                <div class="row">
                                    <div class="col-md-6"><label class="form-label" style="font-size: 13px;">Starting Date</label><input class="form-control" type="date" name="starting_date"></div>
                                    <div class="col-md-6"><label class="form-label" style="font-size: 13px;">Target Completion Date</label><input class="form-control" type="date" name="target_completion_date"></div>
                                </div>
                            </div>
                ...
                <div class="container-fluid">
                    <div class="text-center mt-5"><a href="dashboard.php">← Back to Dashboard</a></div>
                </div>
            </div>
