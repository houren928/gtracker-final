        ...
        <div class="d-flex flex-column" id="content-wrapper">
            <div id="content">
                ...
                <section class="contact-clean">
                    <form method="post" action="ap-edit-activity-post-process.php">
                        <h2 class="text-center">Edit Activity</h2>
                        <!-- <div class="mb-3"><input class="form-control" type="text" name="ap-activity-name" placeholder="Activity Name"></div>
                        <div class="mb-3"><textarea class="form-control" name="ap-activity-description" placeholder="Activity Description" rows="14"></textarea></div>
                        <fieldset style="margin-bottom: .5rem;"><label class="form-label" style="font-size: 13px;">Target Completion Date</label><input class="form-control" type="date"></fieldset>
                        <fieldset style="margin-bottom: .5rem;"><label class="form-label" style="font-size: 13px;">Target Completion Date</label><input class="form-control" type="time"></fieldset>
                        <fieldset style="margin-bottom: .5rem;"><label class="form-label" style="font-size: 13px;">Location</label><input class="form-control" type="text"></fieldset>
                        <div class="mb-3"><a class="btn btn-primary" role="button" href="ap-action-plan-slider.html">save changes</a></div> -->
                        <?php include_once "ap-edit-activity-pre-process.php"; // Always include the database oconnection before accessing the database
                        ?>
                    </form>
                </section>
