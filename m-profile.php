                            ...
                            <div class="card shadow mb-3">
                                ...
                                <div class="card-body">
                                    <form>
                                        ...
                                        <div class="row">
                                            <div class="col">
                                                <div class="mb-3"><label class="form-label" for="first_name"><strong>Age</strong></label><input class="form-control" type="text" id="first_name-1" placeholder="32" name="first_name"></div>
                                            </div>
                                            <div class="col">
                                                <div class="mb-3"><label class="form-label" for="last_name"><strong>Gender</strong></label><input class="form-control" type="text" id="last_name-1" placeholder="Male" name="last_name"></div>
                                            </div>
                                        </div>
                            ...
                            <div class="row">
                                <div class="col">
                                    <div class="card shadow">
                                        ...
                                        <div class="card-body">
                                            <form>
                                                <div class="mb-3"><label class="form-label" for="address"><strong>Contact Number</strong></label><input class="form-control" type="text" id="address-1" placeholder="+60184724920" name="address"></div>
